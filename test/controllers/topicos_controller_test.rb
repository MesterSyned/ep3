...
class TopicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create topico" do
    assert_difference('Topico.count') do
      post topicos_url, params: { topico: { content: @topico.content, title: @topico.title } }
    end
  ...
  test "should update topico" do
    patch topico_url(@topico), params: { topico: { content: @topico.content, title: @topico.title } }
